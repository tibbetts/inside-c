...
define double @_Z8someFuncRKiRKd(i32* nocapture readonly %v, double* nocapture readonly %d) #0 {
  %1 = load i32* %v, align 4, !tbaa !1
  %2 = sitofp i32 %1 to double
  %3 = load double* %d, align 8, !tbaa !5
  %4 = fadd double %2, %3
  ret double %4
}

; Function Attrs: noinline ssp uwtable
define void @_Z13typeInferencev() #1 {
  %1 = alloca %"class.std::__1::locale", align 8
  %2 = alloca %"class.std::__1::locale", align 8
  %v = alloca i32, align 4
  %d = alloca double, align 8
  store i32 12, i32* %v, align 4, !tbaa !1
  store double 0x400D1745D1745D18, double* %d, align 8, !tbaa !5
  %3 = call double @_Z8someFuncRKiRKd(i32* %v, double* %d)
  %4 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* @_ZNSt3__14coutE, i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0))
  %5 = load i32* %v, align 4, !tbaa !1
  %6 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEi(%"class.std::__1::basic_ostream"* %4, i32 %5)
  %7 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* %6, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0))
  %8 = load double* %d, align 8, !tbaa !5
  %9 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd(%"class.std::__1::basic_ostream"* %7, double %8)
  %10 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* %9, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0))
  %11 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd(%"class.std::__1::basic_ostream"* %10, double %3)
  ...
  %19 = bitcast %"class.std::__1::locale"* %2 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %19)
  %20 = bitcast i8* %18 to %"class.std::__1::ios_base"*
  call void @_ZNKSt3__18ios_base6getlocEv(%"class.std::__1::locale"* sret %2, %"class.std::__1::ios_base"* %20)
  %21 = invoke %"class.std::__1::locale::facet"* @_ZNKSt3__16locale9use_facetERNS0_2idE(%"class.std::__1::locale"* %2, %"class.std::__1::locale::id"* @_ZNSt3__15ctypeIcE2idE)
...
; <label>:22                                      ; preds = %0
  ...
  %25 = load i8 (%"class.std::__1::ctype"*, i8)*** %24, align 8, !tbaa !7
...
; <label>:29                                      ; preds = %22, %0
  %30 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
  call void @_ZNSt3__16localeD1Ev(%"class.std::__1::locale"* %2) #6
  resume { i8*, i32 } %30
...
_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit: ; preds = %22
  ...
  %33 = call double @_Z8someFuncRKiRKd(i32* %v, double* %d)
  %34 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* @_ZNSt3__14coutE, i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0))
  %35 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEi(%"class.std::__1::basic_ostream"* %34, i32 12)
  %36 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* %35, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0))
  %37 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd(%"class.std::__1::basic_ostream"* %36, double 0x400D1745D1745D18)
  %38 = call %"class.std::__1::basic_ostream"* @_ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_PKc(%"class.std::__1::basic_ostream"* %37, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0))
  %39 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd(%"class.std::__1::basic_ostream"* %38, double %33)
  %40 = bitcast %"class.std::__1::basic_ostream"* %39 to i8**
  %41 = load i8** %40, align 8, !tbaa !7
  %42 = getelementptr i8* %41, i64 -24
  %43 = bitcast i8* %42 to i64*
  %44 = load i64* %43, align 8
  %45 = bitcast %"class.std::__1::basic_ostream"* %39 to i8*
  %46 = getelementptr inbounds i8* %45, i64 %44
  %47 = bitcast %"class.std::__1::locale"* %1 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %47)
  %48 = bitcast i8* %46 to %"class.std::__1::ios_base"*
  call void @_ZNKSt3__18ios_base6getlocEv(%"class.std::__1::locale"* sret %1, %"class.std::__1::ios_base"* %48)
  %49 = invoke %"class.std::__1::locale::facet"* @_ZNKSt3__16locale9use_facetERNS0_2idE(%"class.std::__1::locale"* %1, %"class.std::__1::locale::id"* @_ZNSt3__15ctypeIcE2idE)
          to label %50 unwind label %57

; <label>:50                                      ; preds = %_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit
  ...
  %53 = load i8 (%"class.std::__1::ctype"*, i8)*** %52, align 8, !tbaa !7
  %54 = getelementptr inbounds i8 (%"class.std::__1::ctype"*, i8)** %53, i64 7
  %55 = load i8 (%"class.std::__1::ctype"*, i8)** %54, align 8
  %56 = invoke signext i8 %55(%"class.std::__1::ctype"* %51, i8 signext 10)
          to label %_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit1 unwind label %57

; <label>:57                                      ; preds = %50, %_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit
  %58 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
  call void @_ZNSt3__16localeD1Ev(%"class.std::__1::locale"* %1) #6
  resume { i8*, i32 } %58

_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit1: ; preds = %50
  call void @_ZNSt3__16localeD1Ev(%"class.std::__1::locale"* %1) #6
  call void @llvm.lifetime.end(i64 8, i8* %47)
  %59 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEE3putEc(%"class.std::__1::basic_ostream"* %39, i8 signext %56)
  %60 = call %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEE5flushEv(%"class.std::__1::basic_ostream"* %39)
  ret void
}
...
declare %"class.std::__1::basic_ostream"* @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd(%"class.std::__1::basic_ostream"*, double) #2
...
; <label>:39                                      ; preds = %.noexc
  ...
  %42 = load i8 (%"class.std::__1::ctype"*, i8)*** %41, align 8, !tbaa !7
...
.body:                                            ; preds = %46, %71
  ...
  call void @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEE6sentryD1Ev(%"class.std::__1::basic_ostream<char, std::__1::char_traits<char> >::sentry"* %__s) #6
  br label %74

; <label>:74                                      ; preds = %.body, %68
  %.0 = phi i8* [ %73, %.body ], [ %70, %68 ]
  %75 = call i8* @__cxa_begin_catch(i8* %.0) #6
...
; <label>:13                                      ; preds = %2
  ...
  %15 = load i64 (%"class.std::__1::basic_streambuf"*, i8*, i64)*** %14, align 8, !tbaa !7
...
_ZNKSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE4dataEv.exit: ; preds = %27, %30
  ...
  %35 = load i64 (%"class.std::__1::basic_streambuf"*, i8*, i64)*** %34, align 8, !tbaa !7
...
_ZNSt3__115basic_streambufIcNS_11char_traitsIcEEE5sputnEPKcl.exit: ; preds = %_ZNKSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE4dataEv.exit
  ...
  call void @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev(%"class.std::__1::basic_string"* %__sp) #6
...
; <label>:45                                      ; preds = %42
  ...
  %47 = load i64 (%"class.std::__1::basic_streambuf"*, i8*, i64)*** %46, align 8, !tbaa !7
...
!8 = metadata !{metadata !"vtable pointer", metadata !4, i64 0}
...
!13 = metadata !{metadata !14, metadata !16, i64 40}
!14 = metadata !{metadata !"_ZTSNSt3__18ios_baseE", metadata !2, i64 8, metadata !15, i64 16, metadata !15, i64 24, metadata !2, i64 32, metadata !2, i64 36, metadata !16, i64 40, metadata !16, i64 48, metadata !16, i64 56, metadata !16, i64 64, metadata !15, i64 72, metadata !15, i64 80, metadata !16, i64 88, metadata !15, i64 96, metadata !15, i64 104, metadata !16, i64 112, metadata !15, i64 120, metadata !15, i64 128}
!15 = metadata !{metadata !"long", metadata !3, i64 0}
!16 = metadata !{metadata !"any pointer", metadata !3, i64 0}
!17 = metadata !{metadata !14, metadata !2, i64 8}
!18 = metadata !{metadata !19, metadata !2, i64 144}
!19 = metadata !{metadata !"_ZTSNSt3__19basic_iosIcNS_11char_traitsIcEEEE", metadata !16, i64 136, metadata !2, i64 144}
!20 = metadata !{metadata !14, metadata !2, i64 32}
!21 = metadata !{metadata !14, metadata !15, i64 24}
!22 = metadata !{metadata !3, metadata !3, i64 0}
!23 = metadata !{metadata !24, metadata !16, i64 16}
!24 = metadata !{metadata !"_ZTSNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6__longE", metadata !15, i64 0, metadata !15, i64 8, metadata !16, i64 16}

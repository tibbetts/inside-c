	...
	.globl	baseA1::setDataA(int)
	.align	4, 0x90
baseA1::setDataA(int):                 ## @_ZN6baseA18setDataAEi
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp2:
...
Ltmp4:
	...
	.globl	baseA1::getDataA() const
	.align	4, 0x90
baseA1::getDataA() const:                ## @_ZNK6baseA18getDataAEv
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp7:
...
Ltmp9:
	...
	.globl	baseB1::setDataB(int)
	.align	4, 0x90
baseB1::setDataB(int):                 ## @_ZN6baseB18setDataBEi
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp12:
...
Ltmp14:
	...
	.globl	baseB1::getDataB() const
	.align	4, 0x90
baseB1::getDataB() const:                ## @_ZNK6baseB18getDataBEv
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp17:
...
Ltmp19:
	...
	.globl	subBoth1::getSum() const
	.align	4, 0x90
subBoth1::getSum() const:                ## @_ZNK8subBoth16getSumEv
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp23:
...
Ltmp27:
	...
	callq	baseA1::getDataA() const
	movl	%eax, %r14d
	addq	$4, %rbx
	movq	%rbx, %rdi
	callq	baseB1::getDataB() const
	addl	%r14d, %eax
	popq	%rbx
	popq	%r14
	popq	%rbp
	...
	.globl	simpleMultiple(int, char const**)
	.align	4, 0x90
simpleMultiple(int, char const**):               ## @_Z14simpleMultipleiPPKc
	.cfi_startproc
...
Ltmp40:
	...
	movl	$5, %esi
	movq	%rbx, %rdi
	callq	baseA1::setDataA(int)
	leaq	-28(%rbp), %rdi
	movl	$7, %esi
	callq	baseB1::setDataB(int)
	movq	%rbx, %rdi
	callq	subBoth1::getSum() const
	movl	%eax, %ebx

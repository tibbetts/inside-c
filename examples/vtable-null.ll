...
@_ZTV8onefield = unnamed_addr constant [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI8onefield to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (i32 (%class.onefield*)* @_ZNK8onefield8getFieldEv to i8*)]
...
!5 = metadata !{metadata !"_ZTS17onefield_subclass", metadata !6, i64 12}
...
!9 = metadata !{metadata !"_ZTS8onefield", metadata !6, i64 8}

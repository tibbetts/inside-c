...
Ltmp7:
	...
	movl	$3, (%rax)
Ltmp0:
	movq	typeinfo for int@GOTPCREL(%rip), %rsi
	xorl	%edx, %edx
	movq	%rax, %rdi
	callq	___cxa_throw
Ltmp1:
...
Lset6 = Leh_func_end0-Ltmp1             ##   Call between Ltmp1 and Leh_func_end0
	...
	.byte	0                       ##   No further actions
                                        ## >> Catch TypeInfos <<
	.long	typeinfo for int@GOTPCREL+4       ## TypeInfo 1
                                        ## >> Filter TypeInfos <<
	.byte	1                       ## FilterInfo -1
	.byte	0
	.align	2
	...
	.globl	throw_string()
	.align	4, 0x90
throw_string():                     ## @_Z12throw_stringv
	.cfi_startproc
	.cfi_personality 155, ___gxx_personality_v0
Leh_func_begin1:
...
Ltmp11:
	movq	typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >@GOTPCREL(%rip), %rsi
	movq	std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >::~basic_string()@GOTPCREL(%rip), %rdx
	movq	%rbx, %rdi
	callq	___cxa_throw
Ltmp12:
LBB1_5:
...
Lset16 = Leh_func_end1-Ltmp12           ##   Call between Ltmp12 and Leh_func_end1
	...
	.byte	125                     ##   Continue to action 2
                                        ## >> Catch TypeInfos <<
	.long	typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >@GOTPCREL+4 ## TypeInfo 1
                                        ## >> Filter TypeInfos <<
	.byte	1                       ## FilterInfo -1
	.byte	0
	.align	2
...
Ltmp32:
	...
	.globl	throw_struct()
	.align	4, 0x90
throw_struct():                     ## @_Z12throw_structv
	.cfi_startproc
	.cfi_personality 155, ___gxx_personality_v0
Leh_func_begin4:
...
Ltmp33:
	movq	typeinfo for my_struct@GOTPCREL(%rip), %rsi
	xorl	%edx, %edx
	movq	%rbx, %rdi
	callq	___cxa_throw
Ltmp34:
...
Lset23 = Leh_func_end4-Ltmp34           ##   Call between Ltmp34 and Leh_func_end4
	...
	.byte	0                       ##   No further actions
                                        ## >> Catch TypeInfos <<
	.long	typeinfo for my_struct@GOTPCREL+4 ## TypeInfo 1
                                        ## >> Filter TypeInfos <<
	.byte	1                       ## FilterInfo -1
	.byte	0
	.align	2
	...
	.section	__TEXT,__text,regular,pure_instructions
	.globl	throwNonexception()
	.align	4, 0x90
throwNonexception():                ## @_Z17throwNonexceptionv
	.cfi_startproc
	.cfi_personality 155, ___gxx_personality_v0
Leh_func_begin5:
...
Lset94 = Leh_func_end5-Ltmp134          ##   Call between Ltmp134 and Leh_func_end5
	...
	.byte	121                     ##   Continue to action 1
                                        ## >> Catch TypeInfos <<
	.long	typeinfo for my_struct@GOTPCREL+4 ## TypeInfo 4
	.long	typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >@GOTPCREL+4 ## TypeInfo 3
	.long	typeinfo for int@GOTPCREL+4       ## TypeInfo 2
	.long	0                       ## TypeInfo 1
	.align	2
...
Lset125 = Leh_func_end10-Ltmp190        ##   Call between Ltmp190 and Leh_func_end10
	...
	.globl	typeinfo name for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > ## @_ZTSNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE
	.weak_definition	typeinfo name for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >
	.align	4
typeinfo name for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >:
	.asciz	"std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >"

	.globl	typeinfo name for std::__1::__basic_string_common<true> ## @_ZTSNSt3__121__basic_string_commonILb1EEE
	.weak_definition	typeinfo name for std::__1::__basic_string_common<true>
	.align	4
typeinfo name for std::__1::__basic_string_common<true>:
	.asciz	"std::__1::__basic_string_common<true>"

	.section	__DATA,__datacoal_nt,coalesced
	.globl	typeinfo for std::__1::__basic_string_common<true> ## @_ZTINSt3__121__basic_string_commonILb1EEE
	.weak_definition	typeinfo for std::__1::__basic_string_common<true>
	.align	3
typeinfo for std::__1::__basic_string_common<true>:
	.quad	vtable for __cxxabiv1::__class_type_info+16
	.quad	typeinfo name for std::__1::__basic_string_common<true>

	.globl	typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> > ## @_ZTINSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE
	.weak_definition	typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >
	.align	4
typeinfo for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >:
	.quad	vtable for __cxxabiv1::__vmi_class_type_info+16
	.quad	typeinfo name for std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >
	.long	0                       ## 0x0
	.long	1                       ## 0x1
	.quad	typeinfo for std::__1::__basic_string_common<true>
	.quad	0                       ## 0x0
...
L_.str:                                 ## @.str
	...
	.section	__TEXT,__const_coal,coalesced
	.globl	typeinfo name for my_struct         ## @_ZTS9my_struct
	.weak_definition	typeinfo name for my_struct
typeinfo name for my_struct:
	.asciz	"my_struct"

	.section	__DATA,__datacoal_nt,coalesced
	.globl	typeinfo for my_struct         ## @_ZTI9my_struct
	.weak_definition	typeinfo for my_struct
	.align	3
typeinfo for my_struct:
	.quad	vtable for __cxxabiv1::__class_type_info+16
	.quad	typeinfo name for my_struct

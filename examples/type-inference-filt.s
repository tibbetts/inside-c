	...
	.globl	someFunc(int const&, double const&)
	.align	4, 0x90
someFunc(int const&, double const&):                     ## @_Z8someFuncRKiRKd
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp2:
...
LCPI1_0:
	...
	.globl	typeInference()
	.align	4, 0x90
typeInference():                    ## @_Z13typeInferencev
	.cfi_startproc
...
Ltmp22:
	...
	leaq	-36(%rbp), %rdi
	leaq	-48(%rbp), %rsi
	callq	someFunc(int const&, double const&)

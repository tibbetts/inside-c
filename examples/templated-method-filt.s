...
LCPI0_0:
	...
	.section	__TEXT,__text,regular,pure_instructions
	.globl	templateMethod()
	.align	4, 0x90
templateMethod():                   ## @_Z14templateMethodv
	.cfi_startproc
...
Ltmp17:
	...
	callq	my_struct<double>::my_struct(double)
...
## BB#2:                                ## %_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE5widenEc.exit
	...
	leaq	-40(%rbp), %rdi
	movl	$5, %esi
	callq	void my_struct<double>::set_field_from<int>(int)
	movq	std::__1::cout@GOTPCREL(%rip), %rdi
	leaq	L_.str(%rip), %rsi
	callq	std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<<<std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >&, char const*)
	movsd	-40(%rbp), %xmm0
...
Lset11 = Leh_func_end0-Ltmp8            ##   Call between Ltmp8 and Leh_func_end0
	...
	.globl	my_struct<double>::my_struct(double)
	.weak_def_can_be_hidden	my_struct<double>::my_struct(double)
	.align	4, 0x90
my_struct<double>::my_struct(double):                  ## @_ZN9my_structIdEC1Ed
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp20:
...
Ltmp22:
	.cfi_def_cfa_register %rbp
	popq	%rbp
	jmp	my_struct<double>::my_struct(double)   ## TAILCALL
	.cfi_endproc
...
Ltmp30:
	...
	.globl	void my_struct<double>::set_field_from<int>(int)
	.weak_def_can_be_hidden	void my_struct<double>::set_field_from<int>(int)
	.align	4, 0x90
void my_struct<double>::set_field_from<int>(int): ## @_ZN9my_structIdE14set_field_fromIiEEvT_
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp33:
...
## BB#0:
	...
	.weak_def_can_be_hidden	my_struct<double>::my_struct(double)
	.align	4, 0x90
my_struct<double>::my_struct(double):                  ## @_ZN9my_structIdEC2Ed
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp84:

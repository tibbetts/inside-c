	...
	.globl	MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)
	.align	4, 0x90
MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >): ## @_ZN12MyExceptionAC2ENSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE
	.cfi_startproc
...
Ltmp10:
	.cfi_offset %r14, -24
	movq	%rdi, %rbx
	leaq	vtable for MyExceptionA+16(%rip), %rax
	movq	%rax, (%rbx)
	leaq	8(%rbx), %rdi
Ltmp0:
...
Lset4 = Leh_func_end0-Ltmp1             ##   Call between Ltmp1 and Leh_func_end0
	...
	.globl	MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)
	.align	4, 0x90
MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >): ## @_ZN12MyExceptionAC1ENSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp13:
...
Ltmp15:
	.cfi_def_cfa_register %rbp
	popq	%rbp
	jmp	MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >) ## TAILCALL
	.cfi_endproc

	.globl	MyExceptionA::~MyExceptionA()
	.align	4, 0x90
MyExceptionA::~MyExceptionA():                 ## @_ZN12MyExceptionAD2Ev
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp19:
...
Ltmp22:
	...
	.globl	MyExceptionA::~MyExceptionA()
	.align	4, 0x90
MyExceptionA::~MyExceptionA():                 ## @_ZN12MyExceptionAD1Ev
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp25:
...
Ltmp27:
	.cfi_def_cfa_register %rbp
	popq	%rbp
	jmp	MyExceptionA::~MyExceptionA()  ## TAILCALL
	.cfi_endproc

	.globl	MyExceptionA::~MyExceptionA()
	.align	4, 0x90
MyExceptionA::~MyExceptionA():                 ## @_ZN12MyExceptionAD0Ev
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp31:
...
Ltmp34:
	...
	callq	MyExceptionA::~MyExceptionA()
	movq	%rbx, %rdi
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	...
	.globl	MyExceptionA::what() const
	.align	4, 0x90
MyExceptionA::what() const:             ## @_ZNK12MyExceptionA4whatEv
	.cfi_startproc
## BB#0:
	pushq	%rbp
Ltmp37:
...
LBB5_3:                                 ## %_ZNKSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE5c_strEv.exit
	...
	.globl	MyExceptionA::as_string() const
	.align	4, 0x90
MyExceptionA::as_string() const:        ## @_ZNK12MyExceptionA9as_stringEv
	.cfi_startproc
	.cfi_personality 155, ___gxx_personality_v0
Leh_func_begin6:
...
## BB#2:                                ## %_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1EPKc.exit
	...
	movq	%rbx, %rdi
	movq	%rax, %rsi
	callq	MyExceptionA::MyExceptionA(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)
Ltmp69:
	leaq	typeinfo for MyExceptionA(%rip), %rax
	leaq	MyExceptionA::~MyExceptionA()(%rip), %rcx
	movq	%rbx, %rdi
	movq	%rax, %rsi
	movq	%rcx, %rdx
	callq	___cxa_throw
...
Lset26 = Leh_func_end8-Ltmp70           ##   Call between Ltmp70 and Leh_func_end8
	...
	.byte	125                     ##   Continue to action 1
                                        ## >> Catch TypeInfos <<
	.long	typeinfo for MyExceptionA@GOTPCREL+4 ## TypeInfo 1
                                        ## >> Filter TypeInfos <<
	.byte	1                       ## FilterInfo -1
	.byte	0
	.align	2
	...
	.section	__TEXT,__text,regular,pure_instructions
	.globl	helloExceptions()
	.align	4, 0x90
helloExceptions():                  ## @_Z15helloExceptionsv
	.cfi_startproc
	.cfi_personality 155, ___gxx_personality_v0
Leh_func_begin9:
...
Ltmp86:
	...
	movq	%rax, %rdi
	movq	%r14, %rsi
	callq	MyExceptionA::as_string() const
Ltmp87:
## BB#4:
Ltmp89:
	leaq	-48(%rbp), %rax
...
Lset81 = Leh_func_end14-Ltmp160         ##   Call between Ltmp160 and Leh_func_end14
	...
	.globl	vtable for MyExceptionA     ## @_ZTV12MyExceptionA
	.align	4
vtable for MyExceptionA:
	.quad	0
	.quad	typeinfo for MyExceptionA
	.quad	MyExceptionA::~MyExceptionA()
	.quad	MyExceptionA::~MyExceptionA()
	.quad	MyExceptionA::what() const
...
L_.str1:                                ## @.str1
	...
	.globl	typeinfo name for MyExceptionA     ## @_ZTS12MyExceptionA
typeinfo name for MyExceptionA:
	.asciz	"MyExceptionA"

	.section	__DATA,__const
	.globl	typeinfo for MyExceptionA     ## @_ZTI12MyExceptionA
	.align	4
typeinfo for MyExceptionA:
	.quad	vtable for __cxxabiv1::__si_class_type_info+16
	.quad	typeinfo name for MyExceptionA
